...
int main( int argc, char** argv )
{
  ...
  IplImage *color3 = cvCreateImage(cvSize(200, 100), IPL_DEPTH_8U, 3);
  IplImage *color4 = cvCreateImage(cvSize(200, 100), IPL_DEPTH_8U, 3);
  IplImage *color5 = cvCreateImage(cvSize(200, 100), IPL_DEPTH_8U, 3);
  IplImage *color6 = cvCreateImage(cvSize(200, 100), IPL_DEPTH_8U, 3);
  ...
  positions = fopen( "/home/pi/Robotronik/robotronik/detection_couleurs/positions_mires.txt", "r" );
  ...
  while( key != 27 ) // 27 = ESCAPE
  {
    ...
    cvRectangle( color3, cvPoint( 0, 0 ), cvPoint( 200, 100 ), chooseColor( computeCriteria( b_sum_3, g_sum_3, r_sum_3 ) ), CV_FILLED, 8, 0 ) ;

    cvRectangle( color4, cvPoint( 0, 0 ), cvPoint( 200, 100 ), chooseColor( computeCriteria( b_sum_4, g_sum_4, r_sum_4 ) ), CV_FILLED, 8, 0 ) ;

    cvRectangle( color5, cvPoint( 0, 0 ), cvPoint( 200, 100 ), chooseColor( computeCriteria( b_sum_5, g_sum_5, r_sum_5 ) ), CV_FILLED, 8, 0 ) ;

    cvRectangle( color6, cvPoint( 0, 0 ), cvPoint( 200, 100 ), chooseColor( computeCriteria( b_sum_6, g_sum_6, r_sum_6 ) ), CV_FILLED, 8, 0 ) ;
