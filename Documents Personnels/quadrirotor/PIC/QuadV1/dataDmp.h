 ...
 * Author: jeremy
 *
 * Created on 30 décembre 2012, 19:53
 */
...
#define prog_uchar unsigned char // import arduino, vraisembablememnt un uchar dans la rom, const suffisant en PIC
#define PROGMEM  // import arduino
